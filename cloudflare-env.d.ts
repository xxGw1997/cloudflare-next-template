/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 420b11311062586a456983708692b3c3)
// Runtime types generated with workerd@1.20251213.0 2025-12-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		DB: D1Database;
		WORKER_SELF_REFERENCE: Fetcher /* cloudflare-next-template */;
		ASSETS: Fetcher;
	}
}
